...
export default function UpdateCategory() {
    ...
    const formik = useFormik(
        {
            enableReinitialize: true, // allows state change in get
            initialValues: {
            ...
            <form onSubmit={formik.handleSubmit}>
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) => {
                            const file =
                                e.currentTarget.files[0] // selected first file
                            if (file) formik
                                .setFieldValue(
                                    "image", file
                                ) // for file use setFielValue
                        }}
                    ></input>
                </div>
                {
                    formik.values.image ?
                        ...
                        : categoryHook.category?.filepath ?
                            <img src={getBackendImageUrl(categoryHook.category?.filepath)}></img>
                            : null
                }
